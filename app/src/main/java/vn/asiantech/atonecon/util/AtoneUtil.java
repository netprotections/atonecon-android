...
public class AtoneUtil {
    ...
    public static String getObjectDataGson() {
        // Create a payment object
        Customer customer = new Customer("Customer Name", "Customer Family Name", "Customer given Name",
                "Name Kana", "Family Name Kana", "Given Name KAna", "0123456789",
                "12122017", "Male", "Atone", "Department", "56000", "Address", "12121212", "abc@gmail.vn", 1, 3);

        List<DestCustomer> destCustomers = new ArrayList<>();
        destCustomers.add(0, new DestCustomer("Customer Name 1", "Name Kana", "Company", "Department",
                "ZipCode", "Address", "Tel", "Email"));
        destCustomers.add(1, new DestCustomer("Customer Name 2", "Name Kana", "Company", "Department",
                "ZipCode", "Address", "Tel", "Email"));
        destCustomers.add(2, new DestCustomer("Customer Name 3", "Name Kana", "Company", "Department",
                "ZipCode", "Address", "Tel", "Email"));
        ...
        Payment payment = new Payment(1, "TransactionNo1", "Sale1", "Descript", "ChecksumBUHOIA_^#*$U",
                customer, destCustomers, shopItems);
